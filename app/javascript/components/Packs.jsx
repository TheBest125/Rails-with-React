...
class Packs extends React.Component {
  ...
  <div className="card-deck d-flex justify-content-center">
    ...
    <div className="card item-card">
      {/* Header Image */}
      <img className="card-img-top" src={ItemTen} alt="Card image cap" />
      {/* Card Body */}
      <div className="card-body">
        <h4 className="card-title">Slim Pack</h4>
        <h5 className="card-title">$ 499</h5>
    ...
    <div className="card item-card">
      {/* Header Image */}
      <img className="card-img-top" src={ItemEleven} alt="Card image cap" />
      {/* Card Body */}
      <div className="card-body">
        <h4 className="card-title">Health Pack</h4>
        <h5 className="card-title">$ 290</h5>
        <p className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
        <a href="#" className="btn btn-primary">+ Add To Cart</a>
        <a href="#" className="btn btn-danger">
          <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="card item-card">
      {/* Header Image */}
      <img className="card-img-top" src={ItemTwelve} alt="Card image cap" />
      {/* Card Body */}
      <div className="card-body">
        <h4 className="card-title">Neat Pack</h4>
        <h5 className="card-title">$ 867</h5>
        <p className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
        <a href="#" className="btn btn-primary">+ Add To Cart</a>
        <a href="#" className="btn btn-danger">
          <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
