...
const Product = ({
  ...
  return (
    ...
    <div className="card-deck d-flex justify-content-center">
      {mapProducts.filter(product => product.category === 'Potions').map((filteredProduct) => (
        ...
        >
          {/* Admin Card */}
          {/* Header Image */}
          <img className="card-img-top" src={filteredProduct.image_url} alt="Card image cap" />
          {/* Card Body */}
          <div className="card-body">
            <h4 className="card-title">{filteredProduct.title}</h4>
            <h5 className="card-title">$ {filteredProduct.price}</h5>
